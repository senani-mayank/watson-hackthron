...
function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
  ...
  $stateProvider
    ...
    .state('app.singleview', {
        ...
        resolve: helper.resolveFor('angularAudioRecorder')
    })
    .state('app.submenu', {
        url: '/submenu',
        title: 'Submenu',
...
App
  ...
  .constant('APP_REQUIRES', {
    ...
    modules: [
	  ...
	  { name: 'angularAudioRecorder', files: ['vendor/angular-audio-recorder.js'] },
	  { name: 'webcam', files: ['vendor/webcam.min.js'] },
	  { name: 'ng-camera', files: ['vendor/ng-camera-webcam.js','vendor/ng-camera.js'] },
	  { name: 'html-camera', files: ['vendor/html-camera.js'] }
